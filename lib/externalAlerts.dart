        ...
        child: SlideTransition(
          ...
          child: Container(
            ...
            padding: EdgeInsets.fromLTRB(
                20,
                widget.gravity == 1 ? statusBarHeight : bottomHeight,
                20,
                widget.gravity == 1 ? 20 : 35),
            decoration: BoxDecoration(
              border: Border.all(width: 1.75, color: parseColor(FILLCOLOUR)),
              borderRadius:
                  BorderRadius.all(Radius.circular(GENERICBORDERRADIUS)),
